...
# Produce `Crossover Function Diagram` graphic

## Requested Outcome

- create one reusable `Crossover Function Diagram` asset
- create it at:
  - `assets/engineering-diagrams/images/diagrams/crossover_function_diagram.svg`
...
- show how the crossover divides frequency bands between drivers
