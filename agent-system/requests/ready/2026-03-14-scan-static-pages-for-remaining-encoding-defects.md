...
- run a fresh defect scan for mojibake, replacement characters, broken punctuation, and malformed metadata across the current static surface
- leave a concrete defect list rather than a vague “encoding pass needed” note
