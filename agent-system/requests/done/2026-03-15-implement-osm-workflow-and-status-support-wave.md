...
Owner: d
Claim ID: 20260316T001958Z-4fe6357f
...
- polished the grouped workflow/status packet across:
  - `BuildChecklist.tsx`
  - `TelemetryLog.tsx`
  - `EquipmentManager.tsx`
  - `InspectorPanel.tsx`
- normalized the remaining mojibake/status-copy leftovers in the packet while
  improving modal and inspector hierarchy
- verified:
