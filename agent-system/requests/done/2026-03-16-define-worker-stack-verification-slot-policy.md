...
Define when a worker stack should reserve a verification slot and what belongs
there.

## Focus

- verifier slot eligibility
- performer carry rules
- same-wave verification
- slot eviction
- low-trust worker limits
