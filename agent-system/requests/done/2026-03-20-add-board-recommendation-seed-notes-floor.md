...
# Add board recommendation seed notes floor
...
- Extend the board recommendation projection with backend-generated seed notes for idle-state packet creation. Use latest completed claim context so the panel can seed the next packet from live board state with less UI-only note composition.
