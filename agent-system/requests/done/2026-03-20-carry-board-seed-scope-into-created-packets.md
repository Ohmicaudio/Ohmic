...
# Carry board seed scope into created packets
...
- When the board seeds a new packet, preserve the suggested claim scope in the generated packet template instead of dropping it. Wire scope_paths through admin-web, admin-api, queueActions, and the agent-request script so seeded packets are closer to claim-ready.
