...
# Add board recommendation seed suggestion floor
...
- When the board is idle, the recommendation projection should carry a suggested next packet title derived from live board progress instead of relying on UI defaults. Wire that suggestion through admin-api, contracts, store, and recommendation panel.
